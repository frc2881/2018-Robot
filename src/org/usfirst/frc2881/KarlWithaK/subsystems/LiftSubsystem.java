...
public class LiftSubsystem extends PIDSubsystem {
    ...
    private final WPI_TalonSRX liftMotor = RobotMap.liftSubsystemLiftMotor;
    private final Encoder liftEncoder = RobotMap.liftSubsystemLiftEncoder;
    private final DigitalInput liftTop = RobotMap.liftSubsystemLiftTop;
    private final DigitalInput liftBottom = RobotMap.liftSubsystemLiftBottom;
